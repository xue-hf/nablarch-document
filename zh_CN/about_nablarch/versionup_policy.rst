...
.. list-table:: バージョンアップの種類
  ...
  * - マイナーバージョンアップ
    - 应用フレームワークに対する大規模な機能追加・変更を伴う機能変更を行います。 |br|
      |br|
      例） |br|
      ・実行制御基盤の刷新
    - 应用フレームワーク |br|
  ...
  * - バグフィックス
    - セキュリティ・運用レベルに致命的な影響を与える、緊急性が高い应用フレームワークの不具合に対応します。
    - 应用フレームワーク
...
後方互換性を維持する範囲
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
应用フレームワークとテスティングフレームワーク（以下「フレームワーク」）のバージョンアップは、
...
.. tip::
  Publishedアノテーションを付与する際は、アーキテクト向けと应用プログラマ向けに分類しています。

  * アーキテクト向けの公開API　→　@Published(tag = "architect")
  * 应用プログラマ向けの公開API　→　@Published

  どちらも公開APIであり、後方互換性が維持されるため、プロジェクト判断でアーキテクト向けの公開APIを
  应用プログラマ向けに公開しても問題ありません。
