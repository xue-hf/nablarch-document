...
\ :download:`默认设置一览 <../../configuration/默认设置一览.xlsx>`\ を確認の上、デフォルト値でPJ要件を満たせない箇所については、環境設定ファイル(configファイル)を修正する。
...
\ :download:`默认设置一览 <../../configuration/默认设置一览.xlsx>`\ でデフォルトコンフィグレーションで設定されている内容が確認できる。
...
\ :download:`默认设置一览 <../../configuration/默认设置一览.xlsx>`\ でデフォルトコンフィグレーションで、プレースホルダーが使われていない設定を確認できる。
