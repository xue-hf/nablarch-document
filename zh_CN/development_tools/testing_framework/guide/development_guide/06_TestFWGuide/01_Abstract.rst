...
+-----------------------+----------------------------+--------------------------------------------------------------------------+
|描述方法 (单元格中描述的\| 自动化测试内的值 [#]_\   |说明                                                                      |
|值)                  |                            |                                                                          |
+=======================+============================+==========================================================================+
|null                   | null                       |如果单元格内描述为「null」 **(半角、不区分大小写)** ，则视为「null」值。例如，想在数据库中注册null值，或在期待值中设置null值时使用。|
+-----------------------+                            +--------------------------------------------------------------------------+
|Null                   |                            |                                                                          |
+-----------------------+----------------------------+--------------------------------------------------------------------------+
|"null"                 |字符串的null                |如果字符串前后被双引号(半角、全角均可)包围，则视为去除前后双引号的字符串。\ [#]_                          |
+-----------------------+                            |                                                                          |
|"NULL"                 |                            |                                                                          |
+-----------------------+----------------------------+例如，如果需要将「null」或「NULL」作为字符串处理，则按描述方法所示描述为「"null"」或「"NULL"」。                           |
|"1⊔"                   | 1⊔                         |                                                                          |
+-----------------------+----------------------------+                                                                          |
|"⊔"                    | ⊔                          |此外，为了清楚表明单元格值包含空格，也可以按描述方法所示描述为「"1?"」或「"?"」。                                       |
+-----------------------+----------------------------+                                                                          |
| "１△"                 | １△                        |                                                                          |
|                       |                            |                                                                          |
+-----------------------+----------------------------+                                                                          |
...
|                       |描述的固定值            |                                                              |
+-----------------------+----------------------------+--------------------------------------------------------------------------+
|${字符类型,字符数} [#]_  |将指定字符类型的指定字符数放大后的值          |可使用的字符串如下。                                            |
|                       |                            |                                                                          |
|                       |                            |半角英文字母,半角数字,半角符号,半角假名,全角英文字母,全角数字,                    |
|                       |                            |全角平假名,全角片假名,全角汉字,全角符号其他,外字                    |
|                       |                            |                                                                          |
+-----------------------+----------------------------+--------------------------------------------------------------------------+
|${binaryFile:文件路    |存储到BLOB列的二进制数    |想在BLOB列中存储文件数据时使用。                      |
|径}                    |据                          |文件路径使用相对于Excel文件的路径描述。                     |
+-----------------------+----------------------------+--------------------------------------------------------------------------+
|\\r                    |\ *CR*\                     |想明确描述换行代码时使用。\ [#]_                         |
+-----------------------+----------------------------+                                                                          |
|\\n                    |\ *LF*\                     |                                                                          |
